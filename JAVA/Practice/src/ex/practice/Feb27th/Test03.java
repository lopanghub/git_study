...
public class Test03 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 12. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num; num = -5 + 3 * 10 / 2;
		 * ①System.out.println(num);
		 */
		// a12. 10

		/*
		 * 13. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num = 10;
		 * 
		...
		/*
		 * 14. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num1 = 10; int num2 = 20; boolean
		 * result;
		 * 
		 * result = ( (num1 > 10) && (num2 > 10) ); ①System.out.println(result); result
		 * = ( (num1 > 10) || (num2 > 10) ); ②System.out.println(result);
		 * ③System.out.println(!result);
		 */ // result 값자체는 여전히 true
		// a14. ① false ② true ③ false

		/*
		 * 15. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num1 = 2; //0010 int num2 = 10;//1010
		 * 
		 * ①System.out.println(num1 & num2); ②System.out.println(num1 | num2);
		 * ③System.out.println(num1 ^ num2); ④System.out.println(~num1);
		 */
		// a15. ① 2 ② 10 ③ 8 ④ 이건몰루

		/*
		 * 16. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num = 8;
		 * 
		...
		/*
		 * 17. 다음 코드가 수행 될 때 출력되는 값을 적어보세요. int num = 10; int num2 = 20;
		 * 
