...
<body>	
	<table>
		...
		<tr><td class="title">성 별</td>
			<td class="content">${sessionScope.member.gender == null
			? "입력안됨" : sessionScope.member.gender}				
			</td></tr>
		...
		<tr><td rowspan="3" class="title">메일수신</td>
			<td class="content">${sessionScope.member.noticeMail ? "공지메일 받음" : "공지메일 받지 않음"}				
			</td></tr>
		<tr><td class="content">${sessionScope.member.addMail ? "공지메일 받음" : "공지메일 받지 않음"}			
			</td></tr>
		<tr><td class="content">${sessionScope.member.infoMail ? "공지메일 받음" : "공지메일 받지 않음"}			
		</td></tr>
