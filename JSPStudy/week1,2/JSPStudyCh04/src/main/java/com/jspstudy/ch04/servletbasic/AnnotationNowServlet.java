...
public class AnnotationNowServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * 웹 브라우저에 출력될 응답문서의 형식과 문자 셋을 지정 ContentType 설정은 Response 객체로 부터 PrintWriter
		...
		/*
		 * HTML 문서 형식에 맞게 웹 브라우저로 전송할 데이터를 작성한다. HTML 문서 형식에 맞게 html 태그부터 제대로 작성해야 하지만
		 * out.println()으로 출력되는 내용은 브라우저에 출력되는 내용이 되므로 기본 태그들은 생략했다.
		 **/
