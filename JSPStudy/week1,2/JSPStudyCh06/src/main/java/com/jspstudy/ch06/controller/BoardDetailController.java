...
public class BoardDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * 테이블에서 하나의 게시 글 정보를 읽어오기 위해서 boardList에서 게시 글 상세보기 요청을 하면서 테이블에서 게시 글 하나를 유일하게
		 * 구분할 수 있는 게시 글 번호를 요청 파라미터로 보냈기 때문에 이 게시 글 번호를 요청 파라미터로 부터 읽어 BoardDao를 통해서
		 * no에 해당하는 게시 글 정보를 읽을 수 있다.
		 *
		 ...
		 * RequestDispatcher 객체를 구하고 /WEB-INF/board/boardDetail.jsp 페이지로 포워딩 한다.
		 **/
