...
public class JSPStudyCh0501Exam extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String[] animalLabels = Arrays.stream(animals).map(animalMap::get).toArray(String[]::new);
		...
		String[] hobbyLabels = Arrays.stream(hobbies).map(hobbyMap::get).toArray(String[]::new);
